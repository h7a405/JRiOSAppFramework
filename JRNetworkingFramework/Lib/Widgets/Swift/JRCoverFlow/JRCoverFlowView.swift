        ...
        for i in 0..<self.layerArray.count {
            ...
            if isToLeft {
                ...
                if self.currentIndex < num {
                    ...
                    newLayer.bounds = CGRect(x: 0, y: 0, width: tempView.viewWidth * scale, height: tempView.viewHeight * scale)
...
//        self.pageControl.currentPage = self.currentIndex
    ...
    func setTempleteLayers() {
        let xOfCenter: CGFloat = self.viewWidth / 2
        let yOfCenter: CGFloat = self.viewHeight / 2
    ...
    func arrangeViews() {
        ...
        for i in startIndex...endIndex {
            ...
            tempLayer.bounds = CGRect(x: 0, y: 0, width: tempView.viewWidth * scale, height: tempView.viewHeight * scale)
