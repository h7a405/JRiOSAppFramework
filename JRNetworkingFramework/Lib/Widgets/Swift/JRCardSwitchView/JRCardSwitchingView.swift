...
extension JRCardSwitchingView {
    func initContents(views: [UIView]?) {
        if views != nil {
            ...
            for i in 0..<self.numberOfCards {
                ...
                tempView.backgroundColor = UIColor.colorWithRed( CGFloat(i) * 30, green: CGFloat(i) * 10, blue: CGFloat(i) * 60)
    ...
    func initPageControl() {
        ...
        self.pageControl.center = CGPoint(x: self.viewWidth / 2, y: self.viewHeight * 0.75)
