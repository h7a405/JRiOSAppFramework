...
//        self.profileAvatar.frame = self.tableHeaderView.centerHorizontal(viewY: 10, widthOfSubView: 60, heightOfSubView: 60)
        self.profileAvatar.frame = CGRect(x: 0, y: 10, width: 60, height: 60)
        self.profileAvatar.viewCenterHorizontal = self.tableHeaderView.viewCenterHorizontal
        self.profileAvatar.layer.masksToBounds = true
        self.profileAvatar.layer.cornerRadius = self.profileAvatar.viewWidth / 2
...
extension SettingViewController: UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        case 0:
            let averageWidth: CGFloat = self.tableView.viewWidth / CGFloat(self.dataOfRows[indexPath.section].count)
