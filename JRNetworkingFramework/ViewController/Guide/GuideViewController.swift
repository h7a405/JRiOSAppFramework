...
class GuideViewController: UIViewController {
    ...
    func setupGuide() {
        for i in 0..<self.numberOfViews {
            ...
            tempView.backgroundColor = UIColor.RGB(red: CGFloat(i * 35), green: 100, blue: 100)
            if i == self.numberOfViews - 1 {
                ...
                enterButton.setTitle(TITLE_ENTER_NOW, forState: UIControlState.Normal)
                ...
                enterButton.frame = rectOfButton
    ...
    func didEnterButtonClicked(sender: UIButton) {
        if IS_SIGNIN_NECESSARY {
            ...
            UIApplication.sharedApplication().mainWindow().rootViewController = signNavigationController
        } else {
