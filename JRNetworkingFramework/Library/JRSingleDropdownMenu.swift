...
class JRSingleDropdownMenu: UIView {
    ...
    var xCoordinateOfTableView: Float = Float(0)
    var yCoordinateOfTableView: Float = Float(0)
    ...
    convenience init(fixedWidth: Float?, fixedHeight: Float?, pointToShow point: (x: Float, y: Float)?, titles: [String]?) {
        ...
        if point != nil {
            self.xCoordinateOfTableView = point!.x
            self.yCoordinateOfTableView = point!.y
        } else {
            self.xCoordinateOfTableView = pointToShowOfTableView_default.x
            self.yCoordinateOfTableView = pointToShowOfTableView_default.y
        }
        if fixedWidth != nil {
        ...
        if self.contentView == nil {
            self.contentView = UIView(frame: CGRect(
                x: CGFloat(self.xCoordinateOfTableView),
                y: CGFloat(self.yCoordinateOfTableView),
